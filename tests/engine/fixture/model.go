// Package fixture owns the canonical logical table data loaded by real-engine
// conformance backends. Semantic assets and result expectations remain in
// tests/conformance; this package describes the one physical data world that
...
// test contract rather than a Renderer authority: Renderers compile queries;
