...
func compile(t *testing.T, query query.SemanticQuery, dialect string) (*semanticplan.SemanticPlan, sql.SQLQuery, error) {
	t.Helper()
	return compileWithFixture(t, query, fixtures.Commerce, dialect)
}

func compileScenario(t *testing.T, scenario scenarios.Scenario, dialect string) (*semanticplan.SemanticPlan, sql.SQLQuery, error) {
	t.Helper()
	return compileWithFixture(t, scenario.Query, scenario.Fixture, dialect)
}

func compileWithFixture(t *testing.T, query query.SemanticQuery, fixture fixtures.ID, dialect string) (*semanticplan.SemanticPlan, sql.SQLQuery, error) {
	t.Helper()
